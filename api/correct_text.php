...
$historyPromptLine = "";
$historyJsonLine = "";
if (!empty($retry_history) || $is_retry) {
    $historyPromptLine = "\n    - 履歴がある場合は、その内容を踏まえて、あなたの進歩や改善点を評価・指摘してください。";
    $historyJsonLine = "履歴がある場合はそれらを踏まえた内容にすること。";
}
...
";
    ...
    - **「伝わるか」の観点でも必ず評価してください。** 文法が不正確でも、ネイティブが聞いて「言いたいことはわかる」と判断できる場合は「文法的には誤りがあるが意味は通じる」と評価してください。一方、単語の羅列やキーワード不足によって「何を伝えたいのかが読み取れない」レベルの場合は、それを文法的な指摘より優先して指摘してください。{$historyPromptLine}
...
";
    ...
    - **重要：不適切な箇所には打ち消し線（~~不適切な箇所~~）、修正後の適切な箇所には太字（**修正後の箇所**）を積極的に使用して、視認性の高いビフォー・アフター形式で添削を行ってください。例：「I ~~goes~~ to school. → I **go** to school.」のように、間違いと正解をセットで示すと非常に分かりやすくなります。**
    - あなたの英語が完璧な場合は、「自然で正しい英語です」とのみ伝えてください。
    - **重要：添削コメントの冒頭に、ユーザーの回答や元の英文を繰り返して含めないでください。ユーザーの回答は別途画面上に表示されるため、二重に表示されてしまいます。直接添削の日本語解説から開始してください。**
...
";
    ...
    出力形式（JSONのみ）:
    {
        \"correction\": \"添削コメント（日本語）。提示済みの英文が使われた場合は間違いとして指摘せず、必要に応じてブラッシュアップ案として記述すること。{$historyJsonLine}無駄な褒め言葉は省略し、解説を重視すること。最後に簡潔な箇条書きのまとめを含めること。\",
        ...
        \"reactions\": [
            {
                ...
                \"suggestion\": \"ルイスなら、課題の日本語（ユーザーの意図）をどう英語で表現するか。 (英語。初級: 教科書的、短く、文法は正しい)\"
            },
            {
                \"level\": 2,
                \"name\": \"エレーナ (教師)\",
                ...
                \"suggestion\": \"エレーナなら、課題の日本語（ユーザーの意図）をどう英語で表現するか。 (英語。中級: 自然で標準的、文法はきれいで正確)\"
            },
            {
                \"level\": 3,
                \"name\": \"ジェームス (ネイティブ)\",
                ...
                \"suggestion\": \"ジェームスなら、課題の日本語（ユーザーの意図）をどう英語で表現するか。 (英語。上級: ネイティブ会話、省略・崩し・スラングあり)\"
            }
        ]
    }
...
";
    ...
    - 「もっと具体的に言ったほうが親切です」といったアドバイスは不要です。あくまで「英語として正しいか」「自然な響きか」に焦点を当ててください。
    - **「伝わるか」の観点でも必ず評価してください。** 文法が不正確でも、ネイティブが聞いて「言いたいことはわかる」と判断できる場合は「文法的には誤りがあるが意味は通じる」と評価してください。一方、単語の列やキーワード不足によって「何を伝えたいのかが読み取れない」レベルの場合は、それを文法的な指摘より優先して指摘してください。{$historyPromptLine}
    - **重要：もしあなたの英語が、下記の「すでに提示済みの英文例」のいずれかと一致、またはほぼ同じである場合は、それを『間違い』として指摘してはいけません。100%正解として扱ってください。**
    - もし提示済みの英文よりもさらに良い、または異なるニュアンスの表現を提案したい場合は、「間違いの指摘」ではなく「さらなるブラッシュアップ案」や「別のバリエーション」としてポジティブに提案してください。
";
...
";
    ...
    出力形式（JSONのみ）:
    {
        \"correction\": \"添削コメント（日本語）。提示済みの英文が使われた場合は間違いとして指摘せず、必要に応じてブラッシュアップ案として記述すること。{$historyJsonLine}無駄な褒め言葉は省略し、解説を重視すること。文脈に合わない場合はその旨を指摘。最後に簡潔な箇条書きのまとめを含めること。\",
        \"suggestions\": " . ($is_retry ? "[]" : "[
            {
                \"english\": \"自然な表現1 (英語)\",
                \"japanese\": \"その日本語訳\",
        ...
        \"reactions\": [
            {
                ...
                \"emoji\": \"🧔\",
                \"reaction\": \"ルイス本人の言葉（日本語・一人称）。日本語を知らない彼が、ユーザーの英語を聞いてどう感じたかを日本語で。理解できた時の喜びや、難しくてわからなかった時の正直な戸惑いを表現。\",
                \"suggestion\": \"ルイスなら、この状況でどう英語で返答するか。 (英語。初級: 教科書的、短く、文法は正しい)\"
            },
            {
                \"level\": 2,
                \"name\": \"エレーナ (中級・論理重視)\",
                \"emoji\": \"👩‍🔬\",
                \"reaction\": \"エレーナ本人の言葉（日本語・一人称）。論理的に理解できたか、どこに情報の不足や文法の違和感を感じたかを日本語で。知的な彼女らしい、少し厳しくも的確なフィードバック。\",
                \"suggestion\": \"エレーナなら、この状況でどう英語で返答するか。 (英語。中級: 自然で標準的、文法はきれいで正確)\"
            },
            {
                \"level\": 3,
                \"name\": \"ジェームス (上級・ネイティブ)\",
                \"emoji\": \"👱‍♂️\",
                \"reaction\": \"ジェームス本人の言葉（日本語・一人称）。ネイティブとしての『自然さ』や『ノリ』がどうだったかを日本語で。友達に話しかけるようなカジュアルでライブ感のある反応。\",
                \"suggestion\": \"ジェームスなら、この状況でどう英語で返答するか。 (英語。上級: ネイティブ会話、省略・崩し・スラングあり)\"
            }
        ]
    }
